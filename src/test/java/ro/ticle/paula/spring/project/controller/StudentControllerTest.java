...
class StudentControllerTest extends BaseControllerTest {
    ...
    void addStudent_Success() throws Exception {
        StudentRequest request = new StudentRequest("John", "Doe", "john.doe@example.com", Set.of("Math"));
    ...
    void addStudent_InvalidEmail() throws Exception {
        StudentRequest request = new StudentRequest("John", "Doe", "invalid-email", Set.of("Math"));
